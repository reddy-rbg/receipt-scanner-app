...
export const DARK_COLORS = { bg:'#080810', surface:'#0f0f1a', surface2:'#16162a', surface3:'#1e1e35', card:'#151528', card2:'#1B1A33', border:'rgba(255,255,255,0.06)', accent:'#7c6aff', accent2:'#ff6a9e', accent3:'#6affd4', text:'#ede8ff', text2:'#7e7a9a', text3:'#3d3a55', green:'#4ade80', red:'#ff6b6b', gold:'#fbbf24', success:'#54E6A5', warning:'#FFD166', danger:'#FF5C7A' };
export const LIGHT_COLORS = { bg:'#F7F7FB', surface:'#FFFFFF', surface2:'#F0F0FA', surface3:'#E5E5F3', card:'#FFFFFF', card2:'#F0F0FA', border:'#DDDDF0', accent:'#6D5DFB', accent2:'#E93D8F', accent3:'#00A88A', text:'#111322', text2:'#6D6A80', text3:'#9A98AA', green:'#12A66A', red:'#D9365E', gold:'#B98500', success:'#12A66A', warning:'#B98500', danger:'#D9365E' };
