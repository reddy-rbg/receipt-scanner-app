...
const createStyles = (C: typeof FALLBACK_COLORS) => StyleSheet.create({
  ...
  statBox:{flex:1,backgroundColor:C.card,borderRadius:12,padding:14,borderWidth:1,borderColor:C.border,borderBottomWidth:2},
  ...
  card:{backgroundColor:C.card,borderRadius:14,borderWidth:1,borderColor:C.border,padding:18,marginBottom:16},
  ...
  uploadZone:{borderWidth:1.5,borderColor:'rgba(128,111,255,0.35)',borderStyle:'dashed',borderRadius:12,padding:28,alignItems:'center',backgroundColor:'rgba(128,111,255,0.05)'},
  ...
  summaryTile:{flex:1,backgroundColor:C.surface2,borderWidth:1,borderColor:C.border,borderRadius:10,padding:10,minHeight:62},
  ...
  resultActionNote:{marginHorizontal:16,marginBottom:4,backgroundColor:'rgba(128,111,255,0.08)',borderWidth:1,borderColor:'rgba(128,111,255,0.22)',borderRadius:10,padding:12},
  ...
  compareBox:{marginHorizontal:16,marginBottom:12,backgroundColor:C.surface,borderWidth:1,borderColor:C.border,borderRadius:12,padding:14},
