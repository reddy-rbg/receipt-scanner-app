...
const createStyles = (C: typeof DARK_COLORS) => StyleSheet.create({
  ...
  searchBox:{ marginHorizontal:16, marginBottom:10, backgroundColor:C.surface2, borderWidth:1, borderColor:C.border, borderRadius:12, flexDirection:'row', alignItems:'center', paddingHorizontal:12 },
  ...
  categoryQuickChip:{ backgroundColor:C.surface, borderWidth:1, borderColor:C.border, borderRadius:10, paddingHorizontal:12, paddingVertical:8 },
  ...
  tab:{ backgroundColor:C.surface2, borderWidth:1, borderColor:C.border, borderRadius:10, paddingHorizontal:14, paddingVertical:8, flexShrink:0 },
  ...
  // Receipt cards
  card:{ backgroundColor:C.card, borderWidth:1, borderColor:C.border, borderRadius:12, padding:16, marginBottom:10, flexDirection:'row', alignItems:'center', gap:10 },
  ...
  detailTile:{ flex:1, backgroundColor:C.surface, borderWidth:1, borderColor:C.border, borderRadius:10, padding:12, minHeight:66 },
  ...
  aiReadyBox:{ backgroundColor:'rgba(128,111,255,0.08)', borderWidth:1, borderColor:'rgba(128,111,255,0.22)', borderRadius:10, padding:12, marginBottom:18 },
